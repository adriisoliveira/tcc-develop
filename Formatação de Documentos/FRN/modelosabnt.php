...
<body 
    <div class="wrapper">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="join-us">
                                  <p><a href="FormatacaoTCC/tabatadomeucoracao.html">FORMATE AQUI SEU TCC </a></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="client owl-carousel owl-theme">
                            <div class="item">
                                <div class="text">
                                    ...
                                    <h5 class="white-button"><a href="#">TUTORIAL</a></h5>
        ...
        <section class="our_activity">
            <h2>TRABALHOS PRONTOS </h2>
            <div class="tabata"><p> Modelos de trabalhos prontos nas normas ABNT NBR 14724 (normalmente pedidas nas escolas) para modificação rápida, fácil e eficiente. </p></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="single-Promo">
                            ...
                            <h2><a href="Modelo-de-Artigo-Cientifico.pdf">Modelo de ARTIGO</a></h2>
                            <p>Este trabalho apresenta os elementos que constituem a estrutura de um artigo
científico, bem como apresenta de forma geral as regras de apresentação, o resumo,
a citação no texto e as referências. As orientações aqui apresentadas baseiam-se na
norma para apresentação de artigo científico, a NBR 6022 de 2003. </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="single-Promo">
                            ...
                            <h2><a href="Modelo TCC.doc">Modelo de TCC</a></h2>
                            <p>Este modelo de trabalho acadêmico contempla os elementos pré-textuais,
textuais e pós-textuais, os principais tipos de citação e a disposição de ilustrações,
figuras e tabelas. Para os itens não mencionados neste modelo, recomenda-se a
consulta às normas na íntegra ou a orientação de um bibliotecário.Este modelo está em conformidade com o Manual de normalização de
documentos científicos de acordo com as normas da ABNT. </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="single-Promo">
                            ...
                            <h2><a href="modelo_monografia.pdf">Modelo de MONOGRAFIA</a></h2>
                            <p>O MODELO DE MONOGRAFIA apresentado contempla os elementos
pré-textuais, textuais, pós-textuais, os principais tipos de citação e a disposição
de ilustrações, figuras e tabelas. O exemplo foi compilado de diversos trabalhos
já apresentados na instituição, modificado e adaptado conforme O Manual de
Normalização de Documentos Científicos de acordo com as normas da
ABNT, publicado pela Editora da UFPR em 2015. </p>
                        </div>
                    </div>
                </div>
            </div>
