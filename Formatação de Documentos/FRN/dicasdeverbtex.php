...
<body 
    <body onLoad="MM_preloadImages('img/news_images_1.jpg')"><div class="wrapper">
        <header class="header">
...
<div class="tabatabusca">
    <P> Encontre na página </P>
<form name="f1" action="" 
onSubmit="if(this.t1.value!=null && this.t1.value!='')
findString(this.t1.value);return false"
>
<div class="tabatabusca2"><input type="text" name=t1 value="" size=20>
<input type="submit" name=b1 value="Buscar"></div>
</form>
</div>

<section class="letast_news">
            <h2>APLICAR NORMAS ABNT NO VERBTEX</h2>
           <div class="tabata"> <p>Tire suas duvidas de como formatar seu trabalho nas normas ABNT com explicações passo a passo de algumas coisas importantes que você precisa saber sobre o VerbTex.</p></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="single_news">
                            <img src="img/verb1.jpg" alt="">
                            <div class="texts">
                              <p class="date"><a href="#">Nas normas ABNT NBR 14724</a></p>
                                <h3>ALINHAMENTO </h3>
                                <div class="tabatatata"><p class="test"> 1. Usando o ambiente center o texto poderá ser centralizado.</p>
<P>2. Com o ambiente flushleft o texto é alinhado a esquerda.</P>
<P>E com o ambiente flushright o texto é alinhado a direita.</P>
</div>
                          </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single_news">
                            <img src="img/verb2.jpg" alt="">
                            <div class="texts">
                                <p class="date"><a href="#">Nas normas ABNT NBR 14724</a></p>
                                <h3>LISTAS </h3>
                                <div class="tabatatata"><p class="test"> Na hora de se construir itens é que pode-se perceber uma das grandes facilidades proporcionadas pelo LaTeX, pois há comandos próprios pra isso.
</p>
 </p></div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="single_news">
                            <img src="img/verb3.jpg" alt="">
                            <div class="texts">
                                <p class="date"><a href="#">Nas normas ABNT NBR 14724</a></p>
                                <h3>SÍMBOLOS MATEMÁTICOS </h3>
                                <div class="tabatatata"> <p class="test">O LaTeX possui vários símbolos para montar fórmulas como integrais, somatórios, letras especiais etc...  </p>
                                </div>
